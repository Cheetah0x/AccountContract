...
export const AccountGroupContractArtifact = loadContractArtifact(AccountGroupContractArtifactJson as NoirCompiledContract);
...
export class AccountGroupContract extends ContractBase {
   ...
   */
  public static deploy(wallet: Wallet, signing_pub_key_x: FieldLike, signing_pub_key_y: FieldLike, admin: AztecAddressLike) {
    return new DeployMethod<AccountGroupContract>(Fr.ZERO, wallet, AccountGroupContractArtifact, AccountGroupContract.at, Array.from(arguments).slice(1));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified public keys hash to derive the address.
   */
  public static deployWithPublicKeysHash(publicKeysHash: Fr, wallet: Wallet, signing_pub_key_x: FieldLike, signing_pub_key_y: FieldLike, admin: AztecAddressLike) {
    return new DeployMethod<AccountGroupContract>(publicKeysHash, wallet, AccountGroupContractArtifact, AccountGroupContract.at, Array.from(arguments).slice(2));
  }
  ...
  public static get storage(): ContractStorageLayout<'signing_public_key' | 'admin'> {
      return {
        signing_public_key: {
      slot: new Fr(1n),
    },
admin: {
      ...
      } as ContractStorageLayout<'signing_public_key' | 'admin'>;
    }
    

  public static get notes(): ContractNotes<'ValueNote' | 'TokenNote' | 'AddressNote' | 'TransparentNote' | 'PublicKeyNote' | 'NewAddressNote'> {
    return {
      ValueNote: {
...
NewAddressNote: {
    ...
    } as ContractNotes<'ValueNote' | 'TokenNote' | 'AddressNote' | 'TransparentNote' | 'PublicKeyNote' | 'NewAddressNote'>;
  }
